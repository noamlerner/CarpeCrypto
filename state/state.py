...
class state(object):
    ...
    Using this class one can:
        ...
        get the minimum number of datapoints required to generate a state.
    '''
    def __init__(self, indicators, with_holding=False):
        ...
        self.with_holding = with_holding
    ...
    def get_state(self,prices_to_date, holding="0"):
        '''
    ...
    def get_similarity_scores(self, states, state):
        '''
        returns a dataframe of scores indexed by state. Each score is a measurement of how similar the two states are, a
        score of 0 is given if two states are exactly the same. Higher scores means the two states are more dissimilar
    ...
    def minimum_datapoints_required(self):
        '''
        returns the minimum amount of data points required to create a state.
        :return:
        '''
        min_required = 1
        for i in self._indicators:
